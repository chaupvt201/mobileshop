							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
					                    ...
					                    <img id="avatar" class="thumbnail" width="300px" src="{{asset('storage/images/'.$product->prod_img)}}">
									</div>
									<div class="form-group" >
										<label>Phụ kiện</label>
										<input required type="text" name="accessories" class="form-control" value="{{$product->prod_accessorories}}">
									</div>
									<div class="form-group" >
									...
									<div class="form-group" >
										...
										Có: <input type="radio" name="featured" @if($product->prod_featured == 1) checked  @endif value="1">
										Không: <input type="radio" name="featured" @if($product->prod_featured == 0) checked @endif value="0">
									</div>
